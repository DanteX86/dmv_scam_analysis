...
class SentinelLauncher:
    ...
    def analyze(self, args: argparse.Namespace) -> int:
        ...
        try:
            ...
            if args.input:
                ...
                # Save results
                output_path = Path(args.output) if args.output else Path('data/processed/analysis_results.json')
    ...
    def _create_parser(self) -> argparse.ArgumentParser:
        ...
        analyze_parser.add_argument('--input', '-i', required=True, help='Input data file')
        ...
        train_parser.add_argument('--model', '-m', required=True, 
                                choices=['classifier', 'embeddings'], help='Model type')
        ...
        setup_parser.add_argument('--environment', '-e', 
