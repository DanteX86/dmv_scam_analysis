...
class SyntheticDataGenerator:
    ...
    def generate_scam_message(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "suspicious_indicators": random.sample(
                self.suspicious_words, random.randint(1, 3)
            ),
        }
    ...
    def generate_balanced_dataset(
        self, scam_count: int = 50, legitimate_count: int = 50
    ) -> List[Dict[str, Any]]:
...
def main() -> None:
    ...
    parser.add_argument(
        "--scam-count", type=int, default=50, help="Number of scam messages to generate"
    )
    parser.add_argument(
        "--legitimate-count",
        type=int,
        default=50,
        help="Number of legitimate messages to generate",
    )
    parser.add_argument(
        "--output",
        type=str,
        default="test_data/synthetic_messages.json",
    ...
    dataset = generator.generate_balanced_dataset(
        args.scam_count, args.legitimate_count
    )
