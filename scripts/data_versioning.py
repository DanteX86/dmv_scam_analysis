...
class DataVersionManager:
    ...
    def get_version_info(
        self, dataset_name: str, version_hash: str
    ...
    def restore_version(
        self, dataset_name: str, version_hash: str, output_path: str
    ) -> bool:
        """
        ...
        backup_path = (
            self.base_path / "backup" / f"{dataset_name}_{version_info['hash'][:8]}.csv"
        )
