...
def main():
    ...
    file_parser.add_argument('--output-dir', default='./analysis_output',
    ...
    message_parser.add_argument('--source', default='cli',
                              help='Message source (e.g., sms, email)')
    message_parser.add_argument('--output-dir', default='./analysis_output',
                              help='Output directory for analysis results')
    ...
    try:
        ...
        if args.command == 'analyze-file':
            ...
            if results['automation_analysis']:
                print(f"- Overall automation score: {results['automation_analysis'].get('overall_automation_score', 0):.2f}")
            ...
            if results['automation_analysis']:
                ...
                print(f"Overall score: {results['automation_analysis'].get('overall_automation_score', 0):.2f}")
