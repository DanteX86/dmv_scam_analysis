...
class RiskAnalyzer:
    ...
    def analyze_risk(self, contact_identifier, temporal_analysis, automation_analysis):
        """
        ...
        report = {
            ...
            'recommendations': self._generate_recommendations(temporal_analysis, automation_analysis)
        }
    ...
    def _generate_recommendations(self, temporal_analysis, automation_analysis):
    ...
    def _generate_summary(self, report, contact_identifier):
