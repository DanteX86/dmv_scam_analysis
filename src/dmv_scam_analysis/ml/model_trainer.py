...
class ModelTrainer:
    ...
    def train_classifier(self, data_path: str, output_path: Optional[str] = None):
        """
    ...
    def train_embeddings(self, data_path: str, output_path: Optional[str] = None):
        """
    ...
    def _prepare_classification_data(self, data: List[Dict]) -> Tuple[List[str], List[int]]:
    ...
    def predict(self, model, texts: List[str]) -> List[Dict]:
