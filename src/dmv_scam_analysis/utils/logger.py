...
def setup_logging(name: str, level: int = logging.INFO, config_path: str = "config/logging_config.yaml") -> logging.Logger:
    """
...
def load_logging_config(config_path: str = "config/logging_config.yaml") -> None:
    """
