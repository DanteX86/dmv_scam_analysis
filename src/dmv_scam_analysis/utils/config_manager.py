...
class ConfigManager:
    ...
    def _create_default_configs(self):
        ...
        if not prod_file.exists():
            prod_config = {
                ...
                "analysis": {
                    "output_dir": "/var/log/sentinel/analysis"
                },
                "logging": {
                    "level": "INFO"
                }
    ...
    def save(self, filename: str = "settings.yaml"):
        """
    ...
    def is_development(self) -> bool:
        ...
        return self.env and self.env.name == "development"
    
    def is_production(self) -> bool:
        """Check if running in production environment"""
        return self.env and self.env.name == "production"
    ...
    def update_from_env(self, prefix: str = "SENTINEL_"):
        """
