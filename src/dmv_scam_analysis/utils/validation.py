...
class DataValidator:
    ...
    def validate_input_data(self, data: Union[pd.DataFrame, Dict]) -> Dict[str, Any]:
        """
    ...
    def _validate_data_rules(self, data: pd.DataFrame):
    ...
    def _apply_validation_rule(self, data: pd.DataFrame, column: str, rule: str):
...
class OutputValidator:
    ...
    def validate_output_format(self, format: str) -> bool:
        ...
        if format.lower() not in valid_formats:
            raise ValidationError(f"Invalid output format. Must be one of: {', '.join(valid_formats)}")
