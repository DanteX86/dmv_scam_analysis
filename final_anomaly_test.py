...
def create_test_scenarios():
    ...
    scenarios["outliers"] = [
        ...
        },
        {
            ...
            "text": (
                "URGENT!!!!!!! " * 50
                + "DMV WILL ARREST YOU TODAY!!!!!!! " * 50
                + "CLICK NOW AT SCAM-SITE.TK OR GO TO JAIL!!!!!!! " * 50
                + "PAY $999 IMMEDIATELY!!!!!!! " * 50
...
def test_scenario(scenario_name, messages, classifier):
    ...
    if statistical_outliers.get("outlier_features"):
        ...
        for i, feature in enumerate(statistical_outliers["outlier_features"][:3]):
            print(
                f"      {i+1}. {feature['feature']}: z-score={feature['z_score']:.2f}"
            )
...
def main():
    ...
    if all_results:
        ...
        for scenario_name, result in all_results.items():
            ...
            print(
                f"{scenario_name:<50} {anomaly_pct:<12}% {is_anomaly:<12} {outlier_count:<10}"
            )
