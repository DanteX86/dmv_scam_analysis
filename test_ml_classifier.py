...
if "overall_assessment" in anomalies:
    ...
    print(
        f"Anomaly Likelihood: {anomalies['overall_assessment']['anomaly_likelihood']}%"
    )
...
print("\nGenerating report...")
report = classifier.generate_ml_report(
    "test_contact", {"predictions": predictions, "anomaly_detection": anomalies}
)
